...
The user may fill out the form field any way they choose as long as it is
a valid US number. The following are examples of valid formats for US
...
function telephoneCheck(str) {
  ...
  // using regex for validating the argument
